...
#include "../../Src/service/info/UpjongCodeUpdater.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UpjongCodeUpdater_t, stringdata0) + ofs \
...
void *UpjongCodeUpdater::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UpjongCodeUpdater.stringdata0))
