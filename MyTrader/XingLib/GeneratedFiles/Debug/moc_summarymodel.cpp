...
#include "../../Src/service/sad/summarymodel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SummaryModel_t, stringdata) + ofs \
...
const QMetaObject SummaryModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_SummaryModel.data,
      qt_meta_data_SummaryModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SummaryModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SummaryModel.stringdata))
        return static_cast<void*>(const_cast< SummaryModel*>(this));
