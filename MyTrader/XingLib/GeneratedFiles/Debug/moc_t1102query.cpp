/****************************************************************************
** Meta object code from reading C++ file 't1102query.h'
**
...
#include "../../Src/core/tr/t1102/t1102query.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 't1102query.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_T1102Query_t, stringdata0) + ofs \
...
static const uint qt_meta_data_T1102Query[] = {
...
void T1102Query::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setShcode(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
const QMetaObject *T1102Query::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *T1102Query::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_T1102Query.stringdata0))
