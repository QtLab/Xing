...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_T8430Query_t, stringdata0) + ofs \
...
void T8430Query::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        T8430Query *_t = static_cast<T8430Query *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
void *T8430Query::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_T8430Query.stringdata0))
