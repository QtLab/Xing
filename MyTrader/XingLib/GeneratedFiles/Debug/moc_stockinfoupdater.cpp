...
#include "../../Src/service/info/stockinfoupdater.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StockInfoUpdater_t, stringdata0) + ofs \
...
void *StockInfoUpdater::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StockInfoUpdater.stringdata0))
