...
#include "../../Src/service/info/movementupdater.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MovementUpdater_t, stringdata0) + ofs \
...
void *MovementUpdater::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MovementUpdater.stringdata0))
