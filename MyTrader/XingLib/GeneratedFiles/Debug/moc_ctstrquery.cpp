...
#include "../../Src/core/tr/ctstrquery.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CtsTrQuery_t, stringdata0) + ofs \
...
void *CtsTrQuery::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CtsTrQuery.stringdata0))
