...
#include "../../Src/core/query/querymngr.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QueryMngr_t, stringdata0) + ofs \
...
void *QueryMngr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QueryMngr.stringdata0))
