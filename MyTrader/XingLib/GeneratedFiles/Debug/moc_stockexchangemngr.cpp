...
#include "../../Src/service/sad/stockexchangemngr.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StockExchangeMngr_t, stringdata0) + ofs \
...
void *StockExchangeMngr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StockExchangeMngr.stringdata0))
