...
public:
    ...
    void setupUi(QDialog *ShcodeSelectionDialog)
    {
        ...
        QWidget::setTabOrder(upjongCombo, searchEdit);
        QWidget::setTabOrder(searchEdit, codeTable);
        QWidget::setTabOrder(codeTable, closeBtn);
        QWidget::setTabOrder(closeBtn, showAllStockBtn);
        QWidget::setTabOrder(showAllStockBtn, showKospiBtn);
        QWidget::setTabOrder(showKospiBtn, showKosdaqBtn);
        QWidget::setTabOrder(showKosdaqBtn, showETFBtn);
        QWidget::setTabOrder(showETFBtn, showETNBtn);
        QWidget::setTabOrder(showETNBtn, showKonexBtn);
        QWidget::setTabOrder(showKonexBtn, showKotcBtn);
        QWidget::setTabOrder(showKotcBtn, showElwBtn);
        QWidget::setTabOrder(showElwBtn, showKospiUpjongBtn);
        QWidget::setTabOrder(showKospiUpjongBtn, showKosdaqUpjongBtn);
        QWidget::setTabOrder(showKosdaqUpjongBtn, showSectorUpjongBtn);
        QWidget::setTabOrder(showSectorUpjongBtn, showSpecialIndexUpjongBtn);
        QWidget::setTabOrder(showSpecialIndexUpjongBtn, showRegisteredBtn);
        QWidget::setTabOrder(showRegisteredBtn, showSectorThemeBtn);
        QWidget::setTabOrder(showSectorThemeBtn, showSectorindexBtn);
        QWidget::setTabOrder(showSectorindexBtn, keepDialog);
