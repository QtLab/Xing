...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_T8424Item_t, stringdata) + ofs \
...
void *T8424Item::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_T8424Item.stringdata))
...
int T8424Item::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        ...
        case 1: *reinterpret_cast< QString*>(_v) = upcode(); break;
        default: break;
        }
        _id -= 2;
        ...
        case 1: setUpCode(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
        _id -= 2;
