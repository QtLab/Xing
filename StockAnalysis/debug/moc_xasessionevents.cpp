...
#include "../XingLib/xasessionevents.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_XASessionEvents_t, stringdata) + ofs \
...
void *XASessionEvents::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_XASessionEvents.stringdata))
