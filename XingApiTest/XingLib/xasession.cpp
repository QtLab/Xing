...
bool XASession::ConnectServer(const QString& address, int port)
{
    QVariant result = session->dynamicCall("ConnectServer(QString szServerIP, int nServerPort)", address, port);
