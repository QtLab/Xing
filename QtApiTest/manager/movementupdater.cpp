...
{
    QSqlQuery qry;
    QString qryString = QString("SELECT COUNT(*) FROM Movement_%1 WHERE `date`='%2'").arg(info->shcode()).arg(item->date().toString(tr("yyyyMMdd")));
